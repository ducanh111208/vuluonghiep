...
document.addEventListener('DOMContentLoaded', function () {
    ...
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.facebook.com/profile.php?id=100047105350183&mibextid=LQQJ4d', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Instagram');
    telegramDiv.addEventListener('click', function () {
        window.open('https://instagram.com/vhiep_07?igshid=MzMyNGUyNmU2YQ==', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    var telegramDiv = document.querySelector('.Tiktok');
    telegramDiv.addEventListener('click', function () {
        window.open('https://www.tiktok.com/@_vhiep_', '_blank');
    });
});
document.addEventListener('DOMContentLoaded', function () {
...
welcomeText.textContent = "Designed By Vũ Lương Hiệp =))";
